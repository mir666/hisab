...
import 'package:hisab/add.dart';
import 'package:hisab/dbHelper.dart';
                  ...
                  ListView.builder(
                      ...
                      itemBuilder: (context, index){
                        ...
                        if(dataAtIndex['type'] == "income"){
                          return incomeTitle(dataAtIndex["amount"], dataAtIndex["data"] , dataAtIndex["note"]);
                        }else{
                          return expenseTitle(dataAtIndex["amount"], dataAtIndex["data"], dataAtIndex["note"]);
                        }
